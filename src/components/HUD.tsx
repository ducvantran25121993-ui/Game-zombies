  ...
  return (
    <div className="absolute inset-0 pointer-events-none select-none flex flex-col justify-between pt-[max(0.35rem,env(safe-area-inset-top,0px))] pb-[max(0.35rem,env(safe-area-inset-bottom,0px))] pl-[max(0.5rem,env(safe-area-inset-left,0px))] pr-[max(0.5rem,env(safe-area-inset-right,0px))] lg:p-4 overflow-hidden">
      ...
      <div className="flex flex-col gap-1.5 w-full max-w-7xl mx-auto pointer-events-auto">
        ...
        {currentArenaEvent && (
          <div 
            className="w-full landscape:w-auto landscape:max-w-sm landscape:self-center landscape:mx-auto px-2.5 py-1 landscape:py-0.5 landscape:px-2 rounded-xl landscape:rounded-lg border flex items-center justify-between gap-1.5 sm:gap-2 shadow-lg backdrop-blur-md animate-pulse pointer-events-none select-none transition-all duration-300"
            style={{ 
          ...
          >
            <div className="flex items-center gap-1.5 min-w-0">
              <span className="text-xs sm:text-sm landscape:text-[8.5px] font-black tracking-wide uppercase truncate" style={{ color: currentArenaEvent.color }}>
            ...
            <span className="font-mono text-[9px] sm:text-[10px] landscape:text-[8px] font-black px-1.5 py-0.2 landscape:px-1 landscape:py-0 rounded bg-black/70 text-zinc-200 border border-zinc-700 shrink-0">
        ...
        <div className="flex items-center justify-between landscape:justify-center gap-1 sm:gap-2 w-full">
          ...
          {bossHp ? (
            <div 
              ...
              className="flex-1 min-w-0 landscape:flex-none landscape:w-[46%] landscape:max-w-sm landscape:mx-auto bg-neutral-950/90 backdrop-blur-md px-1.5 sm:px-2.5 landscape:px-2 py-0.5 landscape:py-0.5 rounded-lg sm:rounded-xl landscape:rounded-lg border border-red-500/70 shadow-md shadow-red-950/40 cursor-pointer hover:border-amber-400/90 transition-all active:scale-[0.99] group select-none"
              title="Click/Chạm để Khóa hoặc Hủy Khóa mục tiêu Boss"
            >
              {/* Boss Info Header */}
              <div className="flex items-center justify-between text-[7px] sm:text-[9.5px] landscape:text-[8px] font-black text-red-200 uppercase tracking-wide gap-1">
                <div className="flex items-center gap-1 min-w-0 flex-1 truncate">
                  <ShieldAlert className="w-2.5 h-2.5 sm:w-3.5 sm:h-3.5 landscape:w-2.5 landscape:h-2.5 text-red-400 shrink-0 animate-pulse group-hover:text-amber-400" />
                  {bossHp.badge && (
                    <span className="px-1 py-0.2 landscape:py-0 rounded bg-amber-500/20 text-amber-300 font-bold border border-amber-500/30 text-[6px] sm:text-[7.5px] landscape:text-[6.5px] shrink-0 hidden xs:inline-block">
                      {bossHp.badge}
                    </span>
                  )}
                  <span className="font-black text-white tracking-wide truncate landscape:text-[8px]">{bossHp.name}</span>
                  {bossHp.currentSkill && (
                    <span className="text-[6px] sm:text-[8px] landscape:text-[7px] text-amber-300 font-mono font-bold bg-amber-950/60 border border-amber-500/40 px-1 py-0.2 landscape:py-0 rounded truncate shrink-0 max-w-[90px] sm:max-w-[180px] landscape:max-w-[105px] flex items-center gap-0.5">
                ...
                <div className="flex items-center gap-1 shrink-0 ml-1">
                  <span className="font-mono text-red-200 font-black text-[7px] sm:text-[9.5px] landscape:text-[7.5px]">
              ...
              <div className="h-1.5 sm:h-2 landscape:h-1 w-full bg-neutral-900 rounded-full overflow-hidden border border-red-900/80 shadow-inner mt-0.5">
                <div 
